 ...
 * @author Mykal Burris
 *
 * Body Calculator Application: computes ideal body weight and body mass index
 *
 */
...
public class BodyCalculator {
	...
	/**
	 * Constructor for BodyCalculator objects - copies parameter value ito instance 
	 *   variables
	 * @param gender
	 ...
	 */
	 public boolean equals(BodyCalculator otherObject){
	    // must compare gender, height and weight values in both objects to determine equality
		 return (height == otherObject.height) &&
				 (weight == otherObject.weight) &&
				 (gender == otherObject.gender);
	 }
	...
	public static void main( String[] args ) {
	   ...
	   // Step 6: Repeat of steps 2 through 5 to create bc3
		...
		System.out.printf("\nBMI=%.3f, IBW=%.2f\n", bc1.getBMI(), bc1.getIdealBodyWeight());
		System.out.printf("BMI=%.3f, IBW=%.2f\n", bc2.getBMI(), bc2.getIdealBodyWeight());
		System.out.printf("BMI=%.3f, IBW=%.2f\n\n", bc3.getBMI(), bc3.getIdealBodyWeight());
